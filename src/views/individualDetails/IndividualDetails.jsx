...
import "../individualDetails/IndividualDetails.css";
...
export default function TableDetails() {
  ...
  const currentPageData = individualObj.slice(offset, offset + Per_Page);
  const totalPages = Math.ceil(individualObj.length) / Per_Page;
          ...
          <Card className="card-plain table-plain-bg">
            ...
            <Card.Body className="table-full-width table-responsive px-0">
              <Table className="table-hover">
                ...
                <tbody>
                  {currentPageData.map((individual, index) => {
                    return (
                      <>
                        <tr>
                          <td> {individual.id}</td>
